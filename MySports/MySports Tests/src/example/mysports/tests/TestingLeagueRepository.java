...
import example.mysports.tests.admin.MockAdminMetadataSource;
...
public class TestingLeagueRepository extends LeagueRepository {
    ...
    public TestingLeagueRepository(MySportsConfig config) {
        super();
        this.config = config;
    }
    ...
    public static Map<String, Object> add(String leagueId, Map<String, Object> properties) {
        ...
        if (leagueId != null) {
            props.put(METADATA_SOURCE, MockAdminMetadataSource.class.getName());
        }
