...
public class RESTAdminServerConnector implements AdminServerConnector {
    ...
    public Leagues getLeagues() {
        ...
        try {
            in = open(null, null);
            return (Leagues) RESTAdminServerConnector.getContext().createUnmarshaller().unmarshal(in);
        } catch (IOException e) {
     ...
     * 
     * @see
     * example.mysports.admin.AdminServerConnector#getLeague(java.lang.String)
     */
